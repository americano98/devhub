  ...
  return (
    <section className="bg-black pt-16 pb-20 text-white md:pt-24 md:pb-28 xl:pt-40 xl:pb-29">
      <div className="relative mx-auto max-w-400 px-5 md:px-8">
        <h1 className="max-w-336 font-sans text-4xl/none font-normal tracking-normal md:text-6xl/none xl:indent-40 xl:text-7xl/none 2xl:text-8xl/none">
        ...
        <p className="text-grey-70 mt-6 max-w-80 text-base/tight xl:absolute xl:right-8 xl:bottom-2 xl:max-w-64">
          {mvp
